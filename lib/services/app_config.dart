...
class AppConfig {
  ...
  static const _androidLanBaseUrl = String.fromEnvironment(
    'ANDROID_LAN_BASE_URL',
    defaultValue: 'https://delicias.saborcentral.com/api',
  );
  ...
  static String get apiBaseUrl {
    if (_apiBaseUrlFromEnv.isNotEmpty) return _normalizeApiUrl(_apiBaseUrlFromEnv);
    if (_customApiBaseUrl != null && _customApiBaseUrl!.isNotEmpty) {
      return _customApiBaseUrl!;
    }
    if (kIsWeb) return 'https://delicias.saborcentral.com/api';
    ...
    switch (defaultTargetPlatform) {
      ...
      case TargetPlatform.macOS:
        return 'https://delicias.saborcentral.com/api';
